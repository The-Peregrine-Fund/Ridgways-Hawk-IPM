...
-----------------------------------------------------------------------   
# 1. Code for Integrated Population Model (IPM)

## 1.1 Model Code 
### 1.1.1 Submodels without Integration
We used a model without integration to obtain adequate initial values and reduce the chance of chains breaking during subsequent runs. 
...
### 1.1.2 Integrated Population Model
...
## 1.2 IPM Results- Figures and Tables
```{r, include=FALSE, cache=FALSE, warning=FALSE }
...
### 1.2.4 Correlations Among Demographic Rates and Detection
...
### 1.2.7 Population Growth Rates and Contributions from Demographics
...
### 2.2.1 Extinction Projections Over Time- Lines
```{r,pva_ext1, eval=TRUE, warning=FALSE, message=FALSE, fig.dim = c(10, 12)}
```

### 2.2.2 Extinction Projections for 2073- Heatmap
```{r,pva_ext2, eval=TRUE, warning=FALSE, message=FALSE, fig.dim = c(10, 12)}
```

### 2.2.3 Abundance Projections
```{r,pva_abund, eval=TRUE, warning=FALSE, message=FALSE, fig.dim = c(10, 12)}
```

### 2.2.4 Time to Extinction
